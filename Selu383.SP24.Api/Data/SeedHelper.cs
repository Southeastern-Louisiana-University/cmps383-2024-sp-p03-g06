...
public static class SeedHelper
{
    ...
    private static async Task AddRoomTypes(DataContext dataContext)
    {
        ...
        var predefinedRooms = new List<RoomType>
        {
            ...
            new RoomType { Name = "King Bed", NumberOfBeds = 1, HotelId = 11},
            new RoomType { Name = "Twin Bed", NumberOfBeds = 2, HotelId = 12},
            new RoomType { Name = "Queen Bed", NumberOfBeds = 2, HotelId = 12},
            new RoomType { Name = "King Bed", NumberOfBeds = 1, HotelId = 12},
            new RoomType { Name = "Twin Bed", NumberOfBeds = 2, HotelId = 13},
            new RoomType { Name = "Queen Bed", NumberOfBeds = 2, HotelId = 13},
